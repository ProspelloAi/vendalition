  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl">
        ...
        {/* Pricing Cards */}
        {/* Pricing Cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12 justify-items-center">
          {/* Top Row: Starter, Growth, Pro, Enterprise */}
          {[...plans, enterprisePlan].map((plan, index) => {
          ...
          {/* Bottom Row: Pilot Offer centered */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.5 }}
            className="md:col-start-2 md:col-span-2 bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-6 shadow-lg w-full text-center"
          >
